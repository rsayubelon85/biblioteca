...
@section('contenido')
    <a href="{{route('users.create')}}" ><img class="card-img-top" title="Crear Trabajador" src="{{asset('/imagen/iconos/plus-square.png')}}" alt="Card image" style="width:40px"></a>
    <input type="text" id="tipo_config" value="usuario_index" hidden="hidden">
    <div class="card">
        <div class="card-body">
