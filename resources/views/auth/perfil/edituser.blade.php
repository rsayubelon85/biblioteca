                ...
                <div class="card-body">
                    <form action={{route('perfil.update',$user)}} method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control" name="last_name" value="{{ old('last_name',$user->last_name) }}" autocomplete="last_name">
                                @error('last_name')
                                    <small>*{{$message}}</small>
                                    <br>
                                @enderror
                        ...
                        <div class="row mb-3">                            
                            <div class="col-md-10">
                                <label class="col-md-12 col-form-label text-md-end">{{ __('Si no desea cambiar la contraseña deje los campos en blanco') }}</label>
                            </div>
                        </div>
                        <div class="row mb-3">                            
                            <label for="last_password" class="col-md-4 col-form-label text-md-end">{{ __('Contraseña anterior') }}</label>

                            <div class="col-md-6">
                                <input id="last_password" type="password" class="form-control" name="last_password" autocomplete="new-password">
                                @error('last_password')
                                    <small>*{{$message}}</small>
                                    <br>
                                @enderror
